...
export const campaignIdForRun = (packet: { frontmatter: { campaign_id?: string } }, runId: string): string =>
...
export const upsertPass = (
  ...
  const base: Campaign = existing ?? { ...init, status: "open" as const, passes: [], updatedAt: pass.atIso }
  return {
    ...base,
    status,
