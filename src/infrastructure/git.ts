...
export const createSandbox = (repo: string, sandboxPath: string, branch: string, base: string): void => {
...
export const readDiffStats = (worktree: string): Record<string, { added: number; removed: number }> => {
